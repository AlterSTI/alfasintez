...
$APPLICATION->AddHeadScript('/ua/script.js');
$APPLICATION->SetAdditionalCSS('/ua/style.css');
    ...
    <div class="av-alert-popup">
        <?/* $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "WEB_FORM_ID" => "3",
                "COMPONENT_TEMPLATE" => "alfasintez-call-back-UA",
        ...
        <? $APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "WEB_FORM_ID" => "3",
                "COMPONENT_TEMPLATE" => "alfasintez-UA",
            )
        ); ?>
    ...
    <div class="ru_main_wrap " style="overflow: hidden;">
        ...
        <div id="mobile-menu-wrap" class="hidden-lg hidden-md">
            ...
            <div class="bg-mobile-menu hidden">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => "/include/av-alfasintez-ua/mobile-menu.php"
                    )
                );?>
            </div>
            ...
            <div class="container container-1st-page">
                <div class="pull-right ">
                    ...
                    <ul id="lang-toggle" class=" hidden-sm hidden-xs">
                        <li class=" green-border-btn active"><a href="/ua/">UA</a></li>
                ...
                <div class="col-md-12 text-center nopadding">
                    <div class="logo-desctope  col-lg-2 col-md-2 col-xs-12">
                        ...
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/main-Logo.php"
                            )
                        );?>
                    </div>
                        ...
                        <section>
                            <nav>
                                <?$APPLICATION->IncludeComponent(
                                    ...
                                    Array(
                                        "AREA_FILE_SHOW" => "file",
                                        "PATH" => "/include/av-alfasintez-ua/main-menu.php"
                                    )
                                );?>
                            </nav>
                        </section>
                    ...
                    <div class="col-md-12 nopadding  main-text-1st-page ">
                        <div class=" hidden-xs">
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    "AREA_FILE_SHOW" => "file",
                                    "PATH" => "/include/av-alfasintez-ua/main-text-1st-page.php"
                                )
                            );?>
                        </div>
                        <div class="hidden-lg hidden-md hidden-sm nopadding">
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    "AREA_FILE_SHOW" => "file",
                                    "PATH" => "/include/av-alfasintez-ua/main-text-1st-page-mobile.php"
                                )
                            );?>
                        </div>
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/main-phone-1st-page.php"
                            )
                        );?>
                        ...
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/download-catalog.php"
                            )
                        );?>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="col-md-6 col-md-offset-3 text-center">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/include/av-alfasintez-ua/section-2-title.php"
                        )
                    );?>
                </div>
                <div class="col-md-6 col-sm-12 pull-left section-2-left-text">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/include/av-alfasintez-ua/section-2-left-text.php"
                        )
                    );?>
                </div>
                <div class="col-md-5 hidden-sm hidden-xs pull-right section-2-right-img text-center ">
                    <div class="eggs-slide-lines hight-line">
                        <div class="line-style"><span class="text-uppercase">екологічно<br>чистий продукт</span></div>
                    </div>
                    <div class="eggs-slide-lines low-line">
                        <div class="line-style"><span class="text-uppercase">європейське<br>обладнання</span></div>
                    </div>
                    <div class="eggs-slide-lines low-line bottom-rotate">
                        <div class="line-style"><span class="text-uppercase">зручність у використанні</span></div>
                    </div>
                    <div class="eggs-slide-lines hight-line bottom-rotate">
                        <div class="line-style"><span class="text-uppercase">міцність матеріалу</span></div>
                    </div>
                    <?$APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        "",
                        Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/include/av-alfasintez-ua/section-2-right-img.php"
                        )
                    );?>
                </div>
            </div>
        ...
        <div class="section-page-3 col-md-12 col-sm-12 nopadding text-center" style="background-color: #fff;">
            ...
            <div class="col-md-6 col-sm-12 left-img">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => "/include/av-alfasintez-ua/section-3-left-text.php"
                    )
                );?>
            </div>
            <div class="col-md-6 col-sm-12 right-img">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => "/include/av-alfasintez-ua/section-3-right-text.php"
                    )
                );?>
            </div>
        </div>
        <div class="section-page-4 col-md-12 col-sm-12 nopadding" style="background-color: #fff;">
            <div class="container">
	            ...
	            <a id="production"></a>
                <div class="col-md-6 col-md-offset-3 text-center">
                    <?$APPLICATION->IncludeFile("/include/av-alfasintez-ua/catalog-title-1.php")?>
                </div>
                <?
                $APPLICATION->IncludeComponent
					(
					"bitrix:catalog.section", "alfasintez-board-UA",
						array(
						"IBLOCK_ID"    => 4,
						"IBLOCK_TYPE"  => "catalog",
						"SECTION_ID"   => 17,
                ...
                ?>
	            <div class="col-md-6 col-md-offset-3 text-center">
		            <?$APPLICATION->IncludeFile("/include/av-alfasintez-ua/catalog-title-2.php")?>
	            </div>
	            <?
	            $APPLICATION->IncludeComponent
	                (
                ...
                <div class="container">
                    <div class="col-md-6 col-md-offset-3 text-center">
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/section-5-title.php"
                            )
                        );?>
                    </div>
                    <div class="section-5-image col-md-12 text-center text-uppercase">
                        ...
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/section-5-imageText-1.php"
                            )
                        );?>
                        </span></div>
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            ...
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    "AREA_FILE_SHOW" => "file",
                                    "PATH" => "/include/av-alfasintez-ua/section-5-imageText-2.php"
                                )
                            );?>
                        </span>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            ...
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    "AREA_FILE_SHOW" => "file",
                                    "PATH" => "/include/av-alfasintez-ua/section-5-imageText-3.php"
                                )
                            );?>
                        </span>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-6 ">
                            ...
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    "AREA_FILE_SHOW" => "file",
                                    "PATH" => "/include/av-alfasintez-ua/section-5-imageText-4.php"
                                )
                            );?>
                        </span>
                        </div>
            ...
            <div class="container">
                ...
                <div class="col-md-6 col-md-offset-3 text-center">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/include/av-alfasintez-ua/section-6-title.php"
                        )
                    );?>
                </div>
                    ...
                    <div class="col-md-3 col-sm-6 nopadding">
                        <div class="section-6-production-img">
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    "AREA_FILE_SHOW" => "file",
                                    "PATH" => "/include/av-alfasintez-ua/section-6-production-img-1.php"
                                )
                            );?>
                        </div>
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/section-6-production-1.php"
                            )
                        );?>
                    </div>
                    <div class="col-md-3 col-sm-6 nopadding">
                        <div class="section-6-production-img">
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    "AREA_FILE_SHOW" => "file",
                                    "PATH" => "/include/av-alfasintez-ua/section-6-production-img-2.php"
                                )
                            );?>
                        </div>
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/section-6-production-2.php"
                            )
                        );?>
                    </div>
                    <div class="col-md-3 col-sm-6 nopadding">
                        <div class="section-6-production-img">
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    "AREA_FILE_SHOW" => "file",
                                    "PATH" => "/include/av-alfasintez-ua/section-6-production-img-3.php"
                                )
                            );?>
                        </div>
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/section-6-production-3.php"
                            )
                        );?>
                    </div>
                    <div class="col-md-3 col-sm-6 nopadding">
                        <div class="section-6-production-img">
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    "AREA_FILE_SHOW" => "file",
                                    "PATH" => "/include/av-alfasintez-ua/section-6-production-img-4.php"
                                )
                            );?>
                        </div>
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/section-6-production-4.php"
                            )
                        );?>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="col-md-6 col-md-offset-3 text-center">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/include/av-alfasintez-ua/section-7-title.php"
                        )
                    );?>
                </div>
                <div class="col-md-12 text-center">
            ...
            <div class="container">
                <div class="col-md-6 col-sm-12 pull-right section-8-left-text">
                    <div class="col-md-12  text-center">
                        ...
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => "/include/av-alfasintez-ua/section-8-title.php"
                            )
                        );?>
                    </div>
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/include/av-alfasintez-ua/section-8-right-text.php"
                        )
                    );?>
                </div>
                <div class="col-md-5 hidden-sm hidden-xs pull-left section-8-right-img text-center ">
                    ...
                    <div class="tomatoes-slide-lines third  low-line bottom-rotate">
                        <div class="line-style"><span class="text-uppercase">зручність<br>у використанні</span></div>
                    </div>
                    <div class="tomatoes-slide-lines fourth hight-line bottom-rotate">
                        <div class="line-style"><span class="text-uppercase">міцність<br>матеріалу</span></div>
                    </div>
                </div>
            ...
            <div class=" col-md-6 col-sm-6 hidden-xs nopadding map-left-text pull-left">
                <div class="col-md-6 pull-right col-sm-7  map-left-text-include text-center">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/include/av-alfasintez-ua/section-9-map-text.php"
                        )
                    );?>
                </div>
